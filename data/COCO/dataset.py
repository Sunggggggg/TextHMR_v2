...
from lib.coord_utils import process_bbox, get_bbox
...
class MSCOCO(torch.utils.data.Dataset):
    def __init__(self, data_split, args):
        ...
        self.img_path = osp.join(cfg.data_dir, dataset_name, 'coco_data')   # /mnt/SKY/PMCE/data/COCO/coco_data
        self.annot_path = osp.join(self.img_path, 'annotations')            # /mnt/SKY/PMCE/data/COCO/coco_data/annotations
