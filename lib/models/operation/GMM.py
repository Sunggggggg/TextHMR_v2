...
class GMM(nn.Module):
    def __init__(
            ...
            atten_drop=0.,
            mask_ratio=0.,
            pretrained=osp.join(cfg.DATASET.BASE_DATA_DIR, 'spin_model_checkpoint.pth.tar'),
    ):
        ...
        self.out_proj = nn.Linear(d_model // 2, d_output)
    ...
    def forward(self, input, is_train=False, J_regressor=None):
        ...
        return smpl_output_global[-1], mask_ids, mem, pred_global
